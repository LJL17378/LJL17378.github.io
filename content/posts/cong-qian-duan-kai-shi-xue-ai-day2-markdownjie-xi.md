...
slug: cong-qian-duan-kai-shi-xue-ai-day2-markdownjie-xi
publishedAt: '2026-01-12'
updatedAt: '2026-01-12'
summary: >-
  前言 昨天我们实现了一个简单的 AI 应用，但是请你看一下下面这张图片
  https://raw.githubusercontent.com/LJL17378/my-img/main/20260112145134133.png
  你会发现目前在前端展示的是一段纯文本，完全没有实现 Markdown 的渲
tags:
  - AI
  - React
  - CSS
draft: false
sourceFile: 【从前端开始学AI】DAY2：Markdown解析.md
---
# 前言
