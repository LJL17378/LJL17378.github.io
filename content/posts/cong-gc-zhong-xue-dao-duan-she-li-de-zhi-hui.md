...
summary: 用整理房间的过程理解垃圾回收：从可达性、分代假说、标记清除与复制压缩，讲到 Node.js/V8、JVM G1、内存泄漏、停顿和资源生命周期管理。
tags:
  - GC
  - Node.js
  - V8
...
![GC 从根集合判断对象是否可达](/posts-assets/gc-room-reachability.svg)
...
![分代垃圾回收中的对象生命周期](/posts-assets/gc-generational-lifecycle.svg)
