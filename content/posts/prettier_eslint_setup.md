...
slug: prettier_eslint_setup
publishedAt: '2025-10-14'
updatedAt: '2025-10-14'
summary: >-
  Prettier + ESLint 自动格式化配置手册 1. 安装依赖 2. Prettier 配置 2.1 创建 .prettierrc.js 注意
  ：如果 package.json 中有 "type": "module" ，必须使用 export default 而不是 module.expor
tags:
  - AI
  - JavaScript
  - 工程化
draft: false
sourceFile: PRETTIER_ESLINT_SETUP.md
---
