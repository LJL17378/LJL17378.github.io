...
slug: yong-nestjsxie-yi-ge-bff
publishedAt: '2026-01-02'
updatedAt: '2026-01-02'
summary: >-
  从 NestJS 入门写一个简单的 BFF 层来做数据清洗 前言 在国内目前的互联网大厂中，后端基本上没有 JS 的容身之地，基本上用的都是 GO 和
  JAVA ，那么我们再去学习使用 JS 进行后端开发还有什么意义呢？一个比较重要的点就是拓宽我们的技术视野，可以去接触一下后端开发相关的知识和概念，
tags:
  - JavaScript
  - Node.js
draft: false
sourceFile: 用NestJS写一个BFF.md
---
