---
title: JS面试手撕系列
slug: jsmian-shi-shou-si-xi-lie
publishedAt: '2026-02-03'
updatedAt: '2026-03-18'
summary: >-
  手写 Promise.all 实现深拷贝 实现浅拷贝 实现new操作符 实现一个instanceof操作符 手写 Object.create 手写节流
  手写防抖 手写 call 手写 apply 手写 bind 手写科里化 手写 Promise 实现 all 实现 race 实现数组的扁平化 实现数
tags:
  - JavaScript
  - 面试
draft: false
sourceFile: JS面试手撕系列.md
---
# 手写 Promise.all
```js
/**
