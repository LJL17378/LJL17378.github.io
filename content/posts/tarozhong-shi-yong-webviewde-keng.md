...
slug: tarozhong-shi-yong-webviewde-keng
publishedAt: '2025-06-22'
updatedAt: '2025-06-22'
summary: >-
  写在最前面：不要轻易当vibe coder，哪怕你要当vibe
  coder也不要去写微信小程序，因为AI对于这个幻觉是比较严重的，所以说如果只是一段比较单纯的逻辑的话用AI还是可以的，但不要太过依赖。很痛苦，还容易变蠢。
  脚本注入和url拦截？ 由于笔者需要在微信小程序中使用cas进行登录，所以就想
tags:
  - AI
  - JavaScript
  - Taro
draft: false
sourceFile: Taro中使用webview的坑.md
---
