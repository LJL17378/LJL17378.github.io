...
slug: reactzhong-de-bi-bao-he-fu-zuo-yong-de-yi-xie-si-kao
publishedAt: '2025-07-06'
updatedAt: '2025-07-06'
summary: >-
  我对于react中的闭包和副作用的一些思考 场景 我今天帮srgg干活的时候想要实现这么一个功能，那就是在进行 websocket
  连接之后设置一个定时器来每隔一段时间就给服务器发消息来控制无人机的 pitch , yaw , factor
  ，我想的是隐藏操作的细节，只发相应的状态过去。那么我就很理
tags:
  - React
  - JavaScript
draft: false
sourceFile: react中的闭包和副作用的一些思考.md
---
