...
slug: openspec-getting-started
publishedAt: '2026-06-10'
updatedAt: '2026-06-10'
summary: >-
  OpenSpec 入门：别再让项目记忆只活在聊天窗口里 一份面向已有项目的 OpenSpec 技术分享与实操手册 内容核对日期：2026 年 6 月 9 日
  开场：代码还在，为什么项目却失忆了？ 想象一个很常见的开发现场。 周一，你和一个 Agent 花了两小时讨论登录系统： - 连续输错五次密码后
tags:
  - AI
  - 工程化
draft: false
sourceFile: openspec-getting-started.md
---
